...
//                }
        ...
        // MARK: 태그 바인딩
        viewModel.tag.bind(to: tagCollectionView.rx.items(cellIdentifier: String(describing: RoundCollectionCell.self), cellType: RoundCollectionCell.self)) { (_, element, cell) in
