...
//                        }
        ...
        viewModel.writeData // write data인지는 모르겠습니다 ... ?
            ...
            .bind(to: bookListCollectionView.rx.items(cellIdentifier: String(describing: BookCoverCollectionCell.self), cellType: BookCoverCollectionCell.self)) { (_, _, _) in
                do {
...
//                    }
        ...
        // 선택됬을 때
        viewModel.selectedData.bind(to: selectedBookListCollectionView.rx.items(cellIdentifier: String(describing: selectedBookCollectionCell.self), cellType: selectedBookCollectionCell.self)) { [unowned self] (_, element, cell) in
