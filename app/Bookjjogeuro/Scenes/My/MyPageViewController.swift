...
//        viewModel.requestUserInfo(userID: 1)
    ...
    func bindViewModel() {
        ...
        viewModel.bookList
            ...
            .bind(to: bookListCollectionView.rx.items(cellIdentifier: String(describing: MyPageBookCollectionCell.self), cellType: MyPageBookCollectionCell.self)) { (_, element, cell) in
